...
<div class="p-4 sm:ml-60 min-h-screen">
    <div class="p-2">
        <h1 class="text-2xl font-semibold mt-10 mb-4">Edit Kelas</h1>
        ...
        <form action="{{ route('kelas.update', $kelas->kelasID) }}" method="POST">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                ...
                <div>
                    ...
                    <input type="text" name="tingkat" id="tingkat" class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" value="{{ $kelas->tingkat }}" required>
                </div>
            </div>
