...
<div class="p-4 sm:ml-60 min-h-screen">
    <div class="p-2">
        <h1 class="text-2xl font-semibold mt-10 mb-4">Tambah Kehadiran Siswa untuk {{ $siswa->namaLengkap }}</h1>
        ...
        <form action="{{ route('siswa.kehadiran.store', $siswaID) }}" method="POST">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                <div>
                    ...
                    <input type="number" name="semester" id="semester" class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                </div>

                <div>
                    <label for="jumlahHadir" class="block mb-2 text-sm font-medium text-gray-900">Jumlah Hadir</label>
                    <input type="number" name="jumlahHadir" id="jumlahHadir" class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" oninput="calculatePercentages()">
                </div>

                <div>
                    <label for="presentaseHadir" class="block mb-2 text-sm font-medium text-gray-900">Presentase Hadir (%)</label>
                    <input type="number" step="0.01" name="presentaseHadir" id="presentaseHadir" class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" readonly>
                </div>

                <div>
                    <label for="sakit" class="block mb-2 text-sm font-medium text-gray-900">Jumlah Sakit</label>
                    <input type="number" name="sakit" id="sakit" class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" oninput="calculatePercentages()">
                </div>

                <div>
                    <label for="izin" class="block mb-2 text-sm font-medium text-gray-900">Jumlah Izin</label>
                    <input type="number" name="izin" id="izin" class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" oninput="calculatePercentages()">
                </div>

                <div>
                    <label for="alpa" class="block mb-2 text-sm font-medium text-gray-900">Jumlah Alpa</label>
                    <input type="number" name="alpa" id="alpa" class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" oninput="calculatePercentages()">
                </div>

                <div>
                    <label for="presentaseTidakHadir" class="block mb-2 text-sm font-medium text-gray-900">Presentase Tidak Hadir (%)</label>
                    <input type="number" step="0.01" name="presentaseTidakHadir" id="presentaseTidakHadir" class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" readonly>
                </div>

                <div>
                    <label for="jumlahHariBelajarEfektif" class="block mb-2 text-sm font-medium text-gray-900">Jumlah Hari Belajar Efektif</label>
                    <input type="number" name="jumlahHariBelajarEfektif" id="jumlahHariBelajarEfektif" class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                </div>
            </div>

            <div class="mt-6 flex justify-between">
                <button type="submit" class="bg-green-600 text-white py-2 px-4 rounded-lg hover:bg-green-700">Tambah Kehadiran</button>
