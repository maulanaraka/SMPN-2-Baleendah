...
<div class="p-4 sm:ml-60 min-h-screen">
    <div class="p-2">
        ...
        <a href="{{ route('kelas.create') }}" class="bg-green-600 text-white py-2 px-4 rounded-lg hover:bg-green-700 mb-3 inline-block">Create New Kelas</a>
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="py-3 px-4 border-b text-center">
                                <div class="flex justify-center space-x-2">
                                    <a href="{{ route('kelas.edit', $kelas->kelasID) }}" class="bg-yellow-500 hover:bg-yellow-600 text-white rounded-lg p-2" title="Edit">
                                    ...
                                    <form action="{{ route('kelas.destroy', $kelas->kelasID) }}" method="POST" class="inline" title="Hapus">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" onclick="return confirm('Apakah Anda yakin ingin menghapus kelas ini?')" class="bg-red-500 hover:bg-red-600 text-white rounded-lg p-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="h-5 w-5">
