...
<div class="p-4 sm:ml-60 min-h-screen">
    <div class="p-2">
        <h1 class="text-2xl font-semibold mt-10 mb-4">Tambah Prestasi</h1>
        ...
        <form action="{{ route('prestasi.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                ...
                <div class="col-span-2 lg:col-span-3">
                    ...
                    <textarea name="keteranganPrestasi" id="keteranganPrestasi" class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 h-10" rows="4" required></textarea>
                </div>
            </div>
