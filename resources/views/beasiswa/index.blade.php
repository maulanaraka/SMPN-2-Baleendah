...
<div class="p-4 sm:ml-60 min-h-screen">
    <div class="p-2">
        <h1 class="text-2xl font-semibold mt-10 mb-4">Data Beasiswa</h1>

        <a href="{{ route('beasiswa.create') }}" class="bg-green-600 text-white py-2 px-4 rounded-lg hover:bg-green-700 mb-3 inline-block">Add Beasiswa</a>
            ...
            <table class="min-w-full bg-white border border-gray-200 rounded-lg shadow-md">
                ...
                <tbody>
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="py-3 px-4 border-b text-center">{{ $beasiswa->beasiswaID }}</td>
                        <td class="py-3 px-4 border-b text-center">{{ $beasiswa->penyelenggara }}</td>
                        <td class="py-3 px-4 border-b text-center">{{ $beasiswa->tahun }}</td>
                        <td class="py-3 px-4 border-b text-center">
                            <div class="flex justify-center space-x-2">
                                <a href="{{ route('beasiswa.edit', $beasiswa->beasiswaID) }}" class="bg-yellow-500 hover:bg-yellow-600 text-white rounded-lg p-2" title="Edit">
                                ...
                                <form action="{{ route('beasiswa.destroy', $beasiswa->beasiswaID) }}" method="POST" class="inline" title="Hapus">
                                    @csrf
                                    @method('DELETE')
